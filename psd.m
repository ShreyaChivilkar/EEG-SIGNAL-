...
for i = 1:11
    ...
    A = appcoef(c,l,'db4',4);
    c_vector= [cd1' , cd2' ,cd3', cd4',cd5', A'];
    y(i,:) = c_vector;
...
% 
% % % Explained indicates maximum variance obtained in 1st 9 coloumns.
...
Mdl8 = fitcsvm(X_train,Y_train,'KernelFunction','gaussian','KernelScale','auto',...
                'ClassNames',{'-1','1'},'Standardize',true);
save('Mdl8.mat');
CVMdl8 = crossval(Mdl8,'KFold',3);
c_out = kfoldPredict(CVMdl8);

save('CVMdl8.mat');

sv = Mdl8.SupportVectors;
