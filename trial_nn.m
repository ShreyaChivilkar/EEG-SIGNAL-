...
% Storing target data into ans matrix. 30 images were shown eachcorresponding to either 1 or -1, to 3 subjects. Total 90 images.
...
Weight = 2*rand(1,4)-1;
 for i = 1:1000
     Weight = method_nn (Weight,input,correct_op);
 end
